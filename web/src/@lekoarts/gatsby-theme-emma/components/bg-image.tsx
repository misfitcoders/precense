    ...
    <div
      sx={{
        ...
        "&:after": {
          ...
          position: `absolute`,
          width: `100%`,
          background: `linear-gradient(to bottom, ${shade} 20%, ${bg} 100%),
      linear-gradient(135deg, ${shade} 10%, ${bg} 100%), linear-gradient(-135deg, ${shade} 10%, ${bg} 100%)`,
        },
      }}
    >
      {children}
